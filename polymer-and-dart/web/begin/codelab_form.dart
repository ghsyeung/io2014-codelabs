...
class CodelabFormElement extends PolymerElement {
  ...
  bool validateTitle() {
    if (codelab.title.length < minTitleLength || codelab.title.length > maxTitleLength) {
      titleErrorMessage = "Title must be between $minTitleLength and $maxTitleLength characters.";
      return false;
    }
    titleErrorMessage = '';
    return true;
  ...
  bool validateDescription() {
    if (codelab.description.length > maxDescriptionLength) {
      descriptionErrorMessage = "Description cannot be more than $maxDescriptionLength characters.";
      return false;
    }
